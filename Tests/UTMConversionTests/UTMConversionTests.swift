...
private let buninyong = LatLongLocationCoordinate2D(latitude: -37.65282114, longitude: 143.92649554)
private let oslo = LatLongLocationCoordinate2D(latitude: 59.912814611065265, longitude: 10.760192985178369)
private let trondheim = LatLongLocationCoordinate2D(latitude: 63.430493678423012, longitude: 10.394966844991798)
private let johannesburg = LatLongLocationCoordinate2D(latitude: -26.214767103043133, longitude: 28.040197220939884)
